...
class MockData{
    ...
    let mockuser = User(username: "586k1Ids5wTrwQicScvDZZJy5ez1", email: "Time Ruchutrakool", uid: "Test@gmail.com", accountType: .passenger, coordinate: GeoPoint(latitude: 13.731991, longitude: 100.52903294563293))
